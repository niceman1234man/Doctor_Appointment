        ...
        <div class="topTitle">
            ...
            <section>
                <div class="accountSetting">
                  ...
                  <input type="email" required name="email" placeholder="fill your email here" class="inpSetAcount"><br>
                  <label for="Name">Name: </label><br>
                  <input type="text" required name="name" placeholder="yuor name here" maxlength="30" class="inpSetAcount"><br>
                  <label for="nic">NIC </label><br>
                  <input type="text" name="NIC" placeholder="your nic here" class="inpSetAcount"><br>
                  <label for="Telephone">Telephone:</label><br>
                  <input type="text" name="Telephone:" placeholder="your Telephone here" maxlength="15"class="inpSetAcount"><br>
                  ...
                  <input type="password" name="Conform Password:" placeholder="Conform Password here" required class="inpSetAcount"><br>
