    ...
    <section class="myApointment" id="myApointment">
        ...
        <div class="Appointments">
            ...
            <div class="setindbtncontener">
                <button class="setingbtn" id="settingbtn" onclick="displaySetting1()">
                    <h1 class="seting"><img src="../images/icons/settings-iceblue.svg">Acount setting <h6
                            class="setingsmalfont">edit you acount detail and change you password</h6>
                    </h1>
                </button>

                <button class="setingbtn" id="detailbtn" onclick="displayDetail()">
                    <h1 class="seting"><img src="../images/icons/view-iceblue.svg">View Account Details</h1>
                    <h6 class="setingsmalfont">view profesional information about you acount</h6> <br>
                </button>
                <button class="setingbtn" id="deletbtn" onclick="displayDelete()">
                    <h1 class="setingdelet"><img src="../images/icons/delete-iceblue.svg" alt="">Delete Acount </h1>
                    <h6 class="setingsmalfont">will permanently delete your acount</h6>
                </button>
            </div>
        </div>
    </section>
...
?>
                ...
                <input type="password" required name="password" placeholder="your password here" maxlength="255"
                    class="inpSetAcount"><br>
                <label for="Conform Password">Conform Password:</label><br>
                <input type="password" name="ConformPassword" placeholder="Conform Password here" maxlength="255"
                    required class="inpSetAcount"><br>
        ...
        <div class="confiDelet">
            ...
            <label for="You want to delete this record(Test Doctor).">You want to delete this record(Test
                Doctor).</label><br>
