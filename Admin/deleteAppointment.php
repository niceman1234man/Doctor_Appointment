...
echo '<center>
    <div
        ...
        <form method="post">
            ...
            <button
                style="text-decoration-style: none; padding: 2%; border-radius: 5px;background-color: rgb(102, 102, 156); color: white;">Confirm</button>
            <a href="Appointment.php"
                style="text-decoration-style: none; padding: 2%; border-radius: 5px;background-color: rgb(102, 102, 156); color: white;">Cancel</a>
        </form>
    </div>
</center>';
return;
...
echo '<center>
    <div
        style="height: 40%; width: 30%; position: absolute; top: 30%; left: 40%;border: 1px solid black;border-radius: 5px;">
        <h1>'.$message.$err.'</h1>
        <button
            style="text-decoration-style: none; padding: 2%; border-radius: 5%;background-color: rgb(102, 102, 156); color: white;"><a
                href="Appointment.php">CLOSE</a></button>
    </div>
</center>';
} else {
