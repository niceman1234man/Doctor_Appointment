...
if (isset($_POST['id'])) {
    ...
    if(isset($_POST['confirm'])) {
        ...
        <div style="height: 40%; width: 20%; position: absolute; top: 30%; left: 40%;border: 1px solid black;border-radius: 5px;box-shadow:10px 10px 10px 10px blue;">
            ...
            <form method="post">
                ...
                <a href="Schedule.php" style="text-decoration-style: none; padding: 2%; border-radius: 5%;background-color: rgb(102, 102, 156); color: white;">Cancel</a>
            </form>
        </div>
        </center>';
        return;
    ...
    echo '<center>
    <div style="height: 30%; width: 20%; position: absolute; top: 30%; left: 40%;border: 1px solid black;border-radius: 5px;">
        <h1>'.$message.$err.'</h1>
